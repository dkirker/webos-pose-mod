...
EmDlgItemID EmDlg::HostRunGetFile (const void* parameters)
{
	...
	Fl_File_Chooser chooser (data.fDefaultPath.IsSpecified () ? data.fDefaultPath.GetFullPath ().c_str () : NULL,
						 filter.c_str (), Fl_File_Chooser::SINGLE, data.fPrompt.c_str ());
...
EmDlgItemID EmDlg::HostRunGetFileList (const void* parameters)
{
	...
	Fl_File_Chooser chooser (data.fDefaultPath.IsSpecified () ? data.fDefaultPath.GetFullPath ().c_str () : NULL,
						 filter.c_str (), Fl_File_Chooser::MULTI, data.fPrompt.c_str ());
...
EmDlgItemID EmDlg::HostRunPutFile (const void* parameters)
{
	...
	Fl_File_Chooser chooser (data.fDefaultPath.IsSpecified () ? data.fDefaultPath.GetFullPath ().c_str () : NULL,
						 filter.c_str (), Fl_File_Chooser::CREATE, data.fPrompt.c_str ());
...
EmDlgItemID EmDlg::HostRunGetDirectory (const void* parameters)
{
	...
	Fl_File_Chooser chooser (data.fDefaultPath.IsSpecified () ? data.fDefaultPath.GetFullPath ().c_str () : NULL,
						 "nEveRmAtCh*", Fl_File_Chooser::DIRECTORY, data.fPrompt.c_str ());
