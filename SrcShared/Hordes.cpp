...
void
Hordes::SStatus (unsigned short *currentNumber, unsigned long *currentStep,
				unsigned long *currentUntil)
{
	gTheGremlin.SStatus (currentNumber, currentStep, currentUntil);
}
...
Hordes::EventCounter (void)
{
	...
	Hordes::SStatus (&number, &step, &until);
